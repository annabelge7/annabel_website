...
/*animation: borderAnimation 5s infinite;  Apply animation to the border */
  ...
  @keyframes borderAnimation {
    ...
    25% {
      border: 15px solid #392d3e; 
    }
    50% {
        border: 15px solid #43354a; 
      }
    75% {
    border: 15px solid #584660; 
    }
    100% {
      border: 15px solid #6d5677; 
    }
  }*/
          ...
          return (
            <div>
              <Header>Me in 10 seconds:</Header>
                ...
                <Paragraph>
                When I am not coding, I like to spend my free time sailing, running, playing guitar, or doing anything outdoors. 
                </Paragraph>
